...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-8">
            <input type="hidden" name="app_id" value="<?php echo e($app ? $app->id : ''); ?>" id="app_id">
            <div class="form-group <?php echo e($errors->has('certi_no') ? 'has-error' : ''); ?>">
                <?php echo HTML::decode(Form::label('certi_no', '<span class="text-danger">*</span>  เลขคำขอ', ['class' => 'col-md-5 control-label'])); ?>

                <div class="col-md-7">
                    <?php echo Form::text('certi_no', $ba->certi_no ?? '', ['class' => 'form-control', 'placeholder'=>'', 'required' => true,'readonly'=>true]);; ?>

                </div>
            </div>
 
            <div class="form-group <?php echo e($errors->has('no') ? 'has-error' : ''); ?>">
                <?php echo HTML::decode(Form::label('no', '<span class="text-danger">*</span>  ชื่อผู้ยื่นคำขอ', ['class' => 'col-md-5 control-label'])); ?>

                <div class="col-md-7">
                    <?php echo Form::text('no',  $ba->no ?? null, ['class' => 'form-control', 'maxlength' => '255', 'required' => true]);; ?>

                </div>
            </div>
            <div class="form-group <?php echo e($errors->has('auditor') ? 'has-error' : ''); ?>">
                <?php echo HTML::decode(Form::label('auditor', '<span class="text-danger">*</span>   ชื่อคณะผู้ตรวจประเมิน', ['class' => 'col-md-5 control-label'])); ?>

                <div class="col-md-7">
                    <?php echo Form::text('auditor', $ba->auditor ?? null, ['class' => 'form-control',  'maxlength' => '255', 'required' => true]);; ?>

                </div>
            </div>

            <?php if(count($ba->DataBoardAuditorDate) > 0): ?>
                <?php $__currentLoopData = $ba->DataBoardAuditorDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $itme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="form-group dev_form_date <?php echo e($errors->has('judgement_date') ? 'has-error' : ''); ?>">
                        <?php if($key == 0): ?>
                        <?php echo HTML::decode(Form::label('judgement_date', '<span class="text-danger">*</span>  วันที่ตรวจประเมิน', ['class' => 'col-md-5 control-label'])); ?>

                        <?php else: ?>
                        <?php echo HTML::decode(Form::label(' ', ' ', ['class' => 'col-md-5 control-label'])); ?>

                        <?php endif; ?>
                    <div class="col-md-6">
                        <div class="input-daterange input-group  date-range">
                            <?php echo Form::text('start_date[]',  !empty($itme->start_date) ?  HP::revertDate($itme->start_date,true) : null, ['class' => 'form-control date' , 'required' => true]); ?>

                            <span class="input-group-addon bg-info b-0 text-white"> ถึง </span>
                            <?php echo Form::text('end_date[]', !empty($itme->end_date) ?  HP::revertDate($itme->end_date,true) : null, ['class' => 'form-control date', 'required' => true]); ?>
            ...
            <?php else: ?>
                <div class="form-group dev_form_date <?php echo e($errors->has('judgement_date') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="input-daterange input-group date-range">
                            <?php echo Form::text('start_date[]', null, ['class' => 'form-control date', 'required' => true]); ?>

                            <span class="input-group-addon bg-info b-0 text-white"> ถึง </span>
                            <?php echo Form::text('end_date[]', null, ['class' => 'form-control date', 'required' => true]); ?>
            ...
            <div class="form-group <?php echo e($errors->has('other_attach') ? 'has-error' : ''); ?>">
                <?php echo HTML::decode(Form::label('other_attach', '<span class="text-danger">*</span> บันทึก ลมอ. แต่งตั้งคณะผู้ตรวจประเมิน', ['class' => 'col-md-5 control-label'])); ?>
                ...
                <div class="col-md-7">
                    ...
                    <?php if($messageRecordTransactions->count() != 0): ?>
                        <table class="table color-bordered-table primary-bordered-table" style="margin-top: 10px">
                            <thead>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $messageRecordTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                        
                                            <td><?php echo e($item->signer_name); ?></td>
                                            <td><?php echo e($item->signer_position); ?></td>
                                            <td>
                                                <span class="badge <?php echo e($item->approval == 1 ? 'bg-success' : 'bg-danger'); ?>">
                                                    <?php echo e($item->approval == 1 ? 'ลงนามแล้ว' : 'รอดำเนินการ'); ?>
            ...
            <div class="form-group <?php echo e($errors->has('attach') ? 'has-error' : ''); ?>">
                <?php echo HTML::decode(Form::label('attach', '<span class="text-danger">*</span> กำหนดการตรวจประเมิน', ['class' => 'col-md-5 control-label'])); ?>

                <div class="col-md-7">
                    <?php if(!is_null($ba->attach) &&  $ba->attach != ''): ?>
                            <a href="<?php echo e(url('certify/check/file_client/'.$ba->attach.'/'.( !empty($ba->attach_client_name) ? $ba->attach_client_name : basename($ba->attach)  ))); ?>" title="<?php echo e(!empty($ba->attach_client_name) ? $ba->attach_client_name :  basename($ba->attach)); ?>" target="_blank">
                                <?php echo HP::FileExtension($ba->attach)  ?? ''; ?>

                               
                            </a>
                            <?php if($ba->status != 1): ?>  
                            <a href="<?php echo e(url('certify/auditor/delete-attach/'. $ba->id )); ?>" class="mb-1 mt-1 mr-1 btn btn-xs btn-danger div_hide"  
            ...
            <div class="form-group <?php echo e($errors->has('auditor') ? 'has-error' : ''); ?>">
                ...
                <div class="col-md-7">
                    <?php if($ba->messageRecordTransactions()->count() != 0): ?>
                        <?php if($ba->message_record_status == 1): ?>
                                <a href="<?php echo e(route('certify.create_lab_message_record',['id' => $ba->id])); ?>"
                                    title="บันทึกแต่งตั้ง" class="btn btn-warning ">
                                    <i class="fa fa-book" aria-hidden="true"> </i>
                                </a>
                            <?php elseif($ba->message_record_status == 2): ?>

                                <a href="<?php echo e(route('view.create_lab_message_record',['id' => $ba->id])); ?>"
    ...
    <table class="table color-bordered-table primary-bordered-table">
        ...
        <tr class="repeater-item">
            <td class="text-center text-top">
                ...
                <div class="form-group <?php echo e($errors->has('taxid') ? 'has-error' : ''); ?>">
                    <div class="col-md-9">
                        <?php echo Form::select('status', $status_auditor,
            ...
            <td class="align-right text-top td-users">
                <?php echo Form::text('filter_search', null, ['class' => 'form-control item', 'placeholder'=>'','data-name'=>'filter_search','required' => true]);; ?>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="white-box">
                                    <div class="row">
                                        <div class="form-group <?php echo e($errors->has('myInput') ? 'has-error' : ''); ?>">
                                            <?php echo HTML::decode(Form::label('myInput', 'ค้นหา', ['class' => 'col-md-2 control-label'])); ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-8">
                                    <div class="pull-right">
                                        <?php echo Form::button('<i class="icon-check"></i> เลือก', ['type' => 'button', 'class' => 'btn btn-primary btn-user-select']); ?>
            ...
            <td class="align-top text-top td-departments">
                <?php echo Form::text('department', null, ('' == 'required') ? ['class' => 'form-control item', 'required' => 'required'] : ['class' => 'form-control item','readonly'=>'readonly','data-name'=>'department']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $ba->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr class="repeater-item">
                ...
                <td class="align-right text-top td-users">
                    <?php
                        $strUsers = "";
                    ?>
                    <?php $__empty_2 = true; $__currentLoopData = $group->auditors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <?php
                            $auditor = $ai->auditor;
                            $strUsers .= (!$loop->first ? ";" : '') . $auditor->id;
                        ?>
                        <?php if($loop->last): ?>
                            <?php echo Form::hidden('users', $strUsers, ['class' => 'item', 'data-name'=>'users']);; ?>

                        <?php endif; ?>
                        <?php echo Form::text('temp_users[]', $auditor->name_th, ['class' => 'form-control item', 'placeholder'=>'','data-name'=>'temp_users[]','required' => true, 'readonly']);; ?>

                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                        <?php echo Form::text('temp_users[]', null, ['class' => 'form-control item', 'placeholder'=>'','data-name'=>'temp_users[]','required' => true, 'readonly']);; ?>
                ...
                <td class="align-top text-top td-departments">
                    <?php $__empty_2 = true; $__currentLoopData = $group->auditors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <?php
                            $auditor = $ai->auditor;
                        ?>
                        <?php echo Form::text('temp_departments[]', $auditor->department->title, ['class' => 'form-control item', 'placeholder'=>'','data-name'=>'temp_departments[]','required' => true, 'readonly']);; ?>

                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                        <?php echo Form::text('temp_departments[]', null, ['class' => 'form-control item', 'placeholder'=>'','data-name'=>'temp_departments[]','required' => true, 'readonly']);; ?>

                    <?php endif; ?>

                </td>
                <td>
                    <?php echo Form::hidden('category', null, ['class' => 'form-control item', 'placeholder'=>'','data-name'=>'category','required' => true, 'readonly', 'data-status' => $key]);; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 m-t-15">
                            <table class="table color-bordered-table primary-bordered-table">
                                ...
                                <tbody id="table_body">
                                    <?php $__currentLoopData = $confirm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td  class="text-center">
                                                1
                                            </td>
                                            <td>
                                                <?php echo Form::select('detail[desc][]',
                                            ...
                                            <td>
                                                <?php echo Form::text('detail[cost][]', number_format($item->amount,2) ?? null,  ['class' => 'form-control input_number cost_rate  text-right','required'=>true]); ?>

                                            </td>
                                            <td>
                                                <?php echo Form::text('detail[nod][]', $item->amount_date ?? null,  ['class' => 'form-control amount_date  text-right','required'=>true]); ?>

                                            </td>
                                            <td>
                                                <?php echo Form::text('number[]',  number_format(($item->amount_date *  $item->amount),2)  ?? null ,  ['class' => 'form-control number  text-right','readonly'=>true]); ?>
                                ...
                                <footer>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo Form::text('costs_total',
                                                null,
...
<?php if(count($ba->CertificateHistorys)): ?>
         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-group" id="accordion">
                        ...
                        <?php $__currentLoopData = $ba->CertificateHistorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $item1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div id="collapse" class="panel-collapse collapse in">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="white-box" style="border: 2px solid #e5ebec;">
                                        <legend>
                                            <h3>
                                               ...
                                               <?php endif; ?>
                                               ครั้งที่ <?php echo e($key1 +1); ?>

                                           </h3>
                                        </legend>
                                        <?php if(!is_null($item1->details)): ?>
                                        <div class="row">
                                          <div class="col-md-4 text-right">
                                             <p class="text-nowrap">ชื่อผู้ยื่นคำขอ</p>
                                          </div>
                                          <div class="col-md-7">
                                            <span><?php echo e($item1->details ?? '-'); ?></span>
                                          </div>
                                         </div>
                                         <?php endif; ?>

                                         <?php if(!is_null($item1->details_one)): ?>
                                         <div class="row">
                                           <div class="col-md-4 text-right">
                                              <p class="text-nowrap">ชื่อคณะผู้ตรวจประเมิน</p>
                                           </div>
                                           <div class="col-md-7">
                                             <span><?php echo e($item1->details_one ?? '-'); ?></span>
                                           </div>
                                          </div>
                                          <?php endif; ?>

                                         <?php if(!is_null($item1->DataBoardAuditorDateTitle)): ?>
                                         <div class="row">
                                           <div class="col-md-4 text-right">
                                              <p class="text-nowrap">วันที่ตรวจประเมิน</p>
                                           </div>
                                           <div class="col-md-7">
                                             <span>   <?php echo @$item1->DataBoardAuditorDateTitle  ?? '-'; ?>  </span>
                                           </div>
                                          </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-7">
                                            <span>
                                                <a href="<?php echo e(url('certify/check/file_client/'.$item1->file.'/'.( !empty($item1->attach_client_name) ? $item1->attach_client_name :  basename($item1->file)  ))); ?>"
                                       ...
                                       <div class="row">
                                         ...
                                         <div class="col-md-7">
                                            <span>
                                             <a href="<?php echo e(url('certify/check/file_client/'.$item1->attachs.'/'.( !empty($item1->attach_client_name) ? $item1->attach_client_name :  basename($item1->attachs)  ))); ?>"
                                                title="<?php echo e(!empty($item1->attach_client_name) ? $item1->attach_client_name :  basename($item1->attachs)); ?>" target="_blank">
                                    ...
                                    <?php endif; ?>
                                    <?php if(!is_null($item1->details_cost_confirm)): ?>
                                      <?php
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                              ...
                                              $SumAmount = 0;
                                              ?>
                                            <?php $__currentLoopData = $details_cost_confirm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php     
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-7">
                                         <label>   <input type="radio" class="check check-readonly" data-radio="iradio_square-green" <?php echo e(($item1->status == 1 ) ? 'checked' : ' '); ?>>  &nbsp;เห็นชอบดำเนินการแต่งตั้งคณะผู้ตรวจประเมินต่อไป &nbsp;</label>
                                         <br>
                                         <label>   <input type="radio" class="check check-readonly" data-radio="iradio_square-red" <?php echo e(($item1->status == 2 ) ? 'checked' : ' '); ?>>  &nbsp;ไม่เห็นชอบ เพราะ  &nbsp;</label>
                                      </div>
                                     </div>
                                   <?php endif; ?>
                                   ...
                                   <div class="row">
                                     ...
                                     <div class="col-md-7">
                                         <?php echo e(@$item1->remark  ?? '-'); ?>

                                     </div>
                                    </div>
                                  <?php endif; ?>
                                  <?php if(!is_null($item1->attachs_file)): ?>
                                  <?php
...
<?php if($ba->status == 1  || $ba->reason_cancel == 1): ?>
<div class="clearfix"></div>
...
<?php $__env->startPush('js'); ?>
  ...
  <script src="https://cdn.jsdelivr.net/npm/pdf-lib@1.17.1/dist/pdf-lib.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        // const pdfUrl = '<?php echo e(asset("assets/pdfs/record.pdf")); ?>';
        ...
        let signatures = [
            <?php $__currentLoopData = $messageRecordTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                {
                    id: '<?php echo e($transaction->signature_id); ?>',
                    enable: <?php echo e($transaction->is_enable == "1" ? 'true' : 'false'); ?>,
                    show_name: <?php echo e($transaction->show_name == "1" ? 'true' : 'false'); ?>,
                    show_position: <?php echo e($transaction->show_position == "1" ? 'true' : 'false'); ?>,
                    signer_name: '<?php echo e($transaction->signer_name); ?>',
                    signer_id: '<?php echo e($transaction->signer_id); ?>',
                    signer_position: '<?php echo e($transaction->signer_position); ?>',
                    line_space: <?php echo e($transaction->linesapce); ?>
        ...
        let signaturePositions = {
            <?php $__currentLoopData = $messageRecordTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                '<?php echo e($transaction->signature_id); ?>': {
                    page: <?php echo e($transaction->page_no); ?>,
                    x: <?php echo e($transaction->pos_x ?? 0); ?>,
                    y: <?php echo e($transaction->pos_y ?? 0); ?>
        ...
        $(document).ready(function () {
           ...
           //ลบตำแหน่ง
            ...
            $('#certi_no').change(function () {
                    ...
                    if($(this).val() != ''){
                        $.ajax({
                           url: "<?php echo url('certify/auditor/certi_no'); ?>" + "/" +  $(this).val()
        ...
        function statusChange(that) {
            ...
            var app_id =   '<?php echo e($ba->app_certi_lab_id ?? null); ?>';
            ...
            if (id !== "" && id !== undefined && checkNone(app_id)) {
                ...
                let url = '<?php echo e(url('/certify/auditor/status/')); ?>'+'/'+id +'/'+ app_id;
                $.ajax({
                    type: 'get',
                    url: url,
    ...
    <script>
       ...
       function openPdfModal() {
        ...
        {
            // const pdfUrl = '<?php echo e(asset("assets/pdfs/flow.pdf")); ?>';
            const signatureUrl = '<?php echo e(asset("assets/signatures/signature1.png")); ?>';
            const fontUrl = '<?php echo e(asset("fonts/THSarabunNew.ttf")); ?>';
