            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-'.str_slug('auditor'))): ?>
                        <a class="btn btn-success pull-right" href="<?php echo e(route('estimated_cost.index', ['app' => $app ? $app->id : ''])); ?>">
                    ...
                    <?php echo Form::open(['url' => route('estimated_cost.update', ['cost' => $ec, 'app' => $app ? $app->id : '']), 'method'=>'put','id'=>'cost_form', 'class' => 'form-horizontal', 'files' => true]); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo e($ec->applicant->app_no ?? null); ?>" disabled >
                                            <input type="hidden" name="app_no" value="<?php echo e($ec->applicant->app_no ?? null); ?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <label class="col-md-2 text-right">หน่วยงาน : </label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" value="<?php echo e($ec->applicant->BelongsInformation->name ?? null); ?>" name="department" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12 m-t-15">
                                        <table class="table color-bordered-table primary-bordered-table">
                                            ...
                                            <tbody id="table-body">
                                                <?php $__currentLoopData = $cost_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                    ...
                    <div class="white-box" style="border: 2px solid #e5ebec;" >
                        ...
                        <div class="row">
                            <div class="col-md-12 text-left" id="scope_wrapper">
                                ...
                                <?php if($ec->attachs !== null && (count(json_decode($ec->attachs)) > 0) ): ?>
                                        <?php
                                            $attachs = json_decode($ec->attachs);
                                        ?>
                                        <?php $__currentLoopData = $attachs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-group ">
  
                                                <div class="col-md-12 text-light">
                                                    <a href="<?php echo e(url('certify/check/file_client/'.$item->attachs.'/'.( !empty($item->file_client_name) ? $item->file_client_name :   basename($item->attachs) ))); ?>" target="_blank">
                                                        <?php echo HP::FileExtension($item->attachs)  ?? ''; ?>

                                                        <?php echo e(!empty($item->file_client_name) ? $item->file_client_name :   basename($item->attachs)); ?>
                                    ...
                                    <?php else: ?>
                                        <?php if($certi_lab_attach_all61->count() > 0): ?>
                                            ...
                                            <?php if($latestFile && $latestFile->file): ?>
                                                <div class="col-md-12 form-group">
                                                    <a href="<?php echo e(url('certify/check/file_client/'.$latestFile->file.'/'.( !is_null($latestFile->file_client_name) ? $latestFile->file_client_name : basename($latestFile->file) ))); ?>" target="_blank">
                                                        <?php echo HP::FileExtension($latestFile->file) ?? ''; ?>

                                                        <?php echo e(!empty($latestFile->file_client_name) ? $latestFile->file_client_name : basename($latestFile->file)); ?>

                                                    </a>
                                                </div>
                                            <?php endif; ?>
                                        <?php elseif($certi_lab_attach_all62->count() > 0): ?>
                                            <?php
                    ...
                    <div class="row form-group" hidden>
                        <div class="col-md-12">
                            ...
                            <legend><h3>ขอบข่ายที่ขอรับการรับรอง (Scope)</h3></legend>
                                ...
                                <?php if($ec->attachs != '' && (count(json_decode($ec->attachs)) > 0) ): ?>
                                <?php
                                        $attachs = json_decode($ec->attachs);
                                 ?>
                                     <div id="attach-box">
                                   ...
                                   <div class="form-group ">
                                       <div class="col-md-4  text-light">
                                        ...
                                        <div class="col-md-1 text-left">
                                            <button class="btn btn-danger btn-sm " type="button" onclick="deleteFlie(<?php echo e($key +1); ?>)">
...
<?php if(count($ec->CertificateHistorys) > 0  && !is_null($ec->date)): ?>
<div class="row form-group">
    <div class="col-md-12">
     <div class="white-box" style="border: 2px solid #e5ebec;">
...
<div id="collapse" class="panel-collapse collapse in">
 <br>
 <?php $__currentLoopData = $ec->CertificateHistorys->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="row form-group">
...
<?php if(!is_null($item->created_at)): ?>
<div class="row">
<div class="col-md-3 text-right">
    <p class="text-nowrap">วันที่บันทึก</p>
</div>
<div class="col-md-9">
    <?php echo e(@HP::DateThai($item->created_at) ?? '-'); ?>
...
<?php if(isset($back)): ?>
    <div class="clearfix"></div>
        <a  href="<?php echo e(url("certify/estimated_cost")); ?>"  class="btn btn-default btn-lg btn-block">
...
<?php else: ?>
   <div id="status_btn"></div>
    <div class="form-group">
         <div class="col-md-18 text-center">
            ...
            <a href="<?php echo e(url('certify/estimated_cost')); ?>" class="btn btn-default"><i class="fa fa-rotate-left"></i> ยกเลิก</a>
        </div>
    </div>
 <?php endif; ?>
 ...
 <?php echo Form::close(); ?>
    ...
    <?php echo $__env->make('certify.extend-modal.lab.cal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            certi_lab = <?php echo json_encode($certi_lab ?? null, 15, 512) ?>;
            certificateHistorys = <?php echo json_encode($ec->CertificateHistorys ?? null, 15, 512) ?>;
            labCalScopeTransactionGroups = <?php echo json_encode($labCalScopeTransactionGroups ?? null, 15, 512) ?>;
        ...
        function  deleteFlie(no){
            Swal.fire({
                    ...
                    cancelButtonText: 'ยกเลิก'
                        ...
                        if (result.value) {
                            let id = "<?php echo e($ec->id ?? null); ?>";
                           $.ajax({
                                url: "<?php echo url('/certify/estimated_cost/delete_file'); ?>" + "/" + id + "/" + no
                            }).done(function( object ) {
                                if(object == 'delete_file'){
                                    $(this).parent().parent().remove();
                                    window.location.assign("<?php echo e(route('estimated_cost.edit', ['ec' => $ec, 'app' => $app ? $app->id : ''])); ?>");
                                }else{
                                    alert('ข้อมูลผิดพลาด');
                                }
                            });
