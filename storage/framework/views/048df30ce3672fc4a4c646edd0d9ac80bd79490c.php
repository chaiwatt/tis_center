    ...
    <div class="white-box"style="border: 2px solid #e5ebec;">
        ...
        <div class="row">
            <div class="col-md-11 col-md-offset-1">
                  ...
                  <div class="col-md-12">
                            <?php if(!is_null($certi_lab_attach_all8) && $certi_lab_attach_all8->count() > 0): ?>
                            <div class="row">
                                <?php $__currentLoopData = $certi_lab_attach_all8; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($data->file): ?>
