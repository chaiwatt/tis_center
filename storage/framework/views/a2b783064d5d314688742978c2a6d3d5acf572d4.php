...
<div class="white-box"style="border: 2px solid #e5ebec;">
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="col-md-12">
            <div class="row">
                 ...
                 <label for="purpose_type">
                    <?php echo e($certi_lab_info->petitioner_name); ?>
        ...
        <?php if($certi_lab_info->petitioner == 2): ?>
        <div class="col-md-12">
            <div class="row">
                 ...
                 <div class="col-md-10 text-left">
                    ...
                    <?php if($certi_lab_info->lab_type_other == 0): ?>
                    ...
                    <br>
                    <?php if($certi_lab_info->desc_main_file): ?>
                        
                        <div style="margin-top: 1.1rem;margin-left: 0.5rem;">
                            <a href="<?php echo e(url('certify/check/file_client/'.$certi_lab_info->desc_main_file.'/'.( !is_null($certi_lab_info->activity_client_name) ? $certi_lab_info->activity_client_name :  basename($certi_lab_info->desc_main_file) ))); ?>" target="_blank">
                                <?php echo HP::FileExtension($certi_lab_info->desc_main_file)  ?? ''; ?>

                                <?php echo e(basename($certi_lab_info->desc_main_file)); ?>
                    ...
                    <br>
                    <?php if($certi_lab_info->only_own_depart == 0): ?>
                    ...
                    <br>
                    <?php if($certi_lab_info->depart_other == 0): ?>
                        <label><input type="radio" class="check  check-readonly" data-radio="iradio_square-green" disabled checked> &nbsp;ใช่ &nbsp;</label>
                        <label><input type="radio" class="check  check-readonly" data-radio="iradio_square-red" disabled > &nbsp;ไม่ใช่ &nbsp;</label>
                    <?php else: ?>
                        <label><input type="radio" class="check  check-readonly" data-radio="iradio_square-green" disabled > &nbsp;ใช่ &nbsp;</label>
         ...
         <?php if($certi_lab_info->petitioner == 7): ?>
         <div class="col-md-12">
            <div class="row">
                 <div class="col-md-2 text-right"> </div>
                 <div class="col-md-10 text-left">
                     ...
                     <div class="checkbox checkbox-success">
                        <input  type="checkbox"  disabled <?php echo e(($certi_lab_info->over_twenty === 0) ? 'checked' : ''); ?>>
                        <label for="#">     &nbsp;อายุไม่ต่ำกว่า 20 ปี &nbsp; </label>
                    </div>
                    <div class="checkbox checkbox-success">
                        <input  type="checkbox"  disabled <?php echo e(($certi_lab_info->not_bankrupt === 0) ? 'checked' : ''); ?>>
                        <label for="#">     &nbsp;ไม่เป็นบุคคลล้มละลาย&nbsp; </label>
                    </div>
                    <div class="checkbox checkbox-success">
                        <input  type="checkbox"  disabled <?php echo e(($certi_lab_info->not_being_incompetent === 0) ? 'checked' : ''); ?>>
                        <label for="#">     &nbsp;ไม่เป็นคนไร้ความสามารถหรือคนเสมือนไร้ความสามารถ&nbsp; </label>
                    </div>
                    <div class="checkbox checkbox-success">
                        <input  type="checkbox"  disabled <?php echo e(($certi_lab_info->suspended_using_a_certificate === 0) ? 'checked' : ''); ?>>
                        <label for="#">     &nbsp;ไม่เป็นผู้อยู่ในระหว่างถูกสั่งพักใช้ใบรับรอง&nbsp; </label>
                    </div>
                    <div class="checkbox checkbox-success">
                        <input  type="checkbox"  disabled <?php echo e(($certi_lab_info->never_revoke_a_certificate === 0) ? 'checked' : ''); ?>>
