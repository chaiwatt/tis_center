...
<div style="position: relative;">
    <div style="display:inline-block;width:15%;float:left;text-align:center;padding: left 0;">
        <div style="position: absolute; top: 68mm; left: 75mm; width: 100mm;">
            <img src="<?php echo e(public_path('images/certificate-header.jpg')); ?>" style="width: 70px" alt="">
        </div>
    </div>
...
<table style="margin-top: px;margin-bottom: 5px">
    <tr style="display:block">
        ...
        <td style="border-bottom: 1px dotted #000; padding-bottom: 1;line-height: 0.6;width: 280px;padding-left:20px">
            <?php echo e($boardAuditorMsRecordInfo->header_text1); ?>
        ...
        <td style="border-bottom: 1px dotted #000; padding-bottom: 1;line-height: 0.6;width: 200px;padding-left:40px">
            <?php echo e($boardAuditorMsRecordInfo->header_text4); ?>
...
<table style="margin-top: 10px;margin-bottom: 5px">
    <tr style="display:block">
        ...
        <td style="border-bottom: 1px dotted #000; padding-bottom: 1;line-height: 0.6;width: 320px;padding-left:20px">
            <?php echo e($boardAuditorMsRecordInfo->header_text3); ?>
...
<table style="margin-top: 10px;margin-bottom: 5px">
    <tr style="display:block">
        ...
        <td style="border-bottom: 1px dotted #000; padding-bottom: 1;line-height: 0.6;width: 600px;padding-left:20px">
            การแต่งตั้งคณะผู้ตรวจประเมินห้องปฏิบัติการ ( คำขอเลขที่ <?php echo e($data->app_no); ?> )
        </td>
    </tr>
</table>
...
<div style="position: absolute; top: 65mm; left: 75mm; width: 100mm">
    <div style=";text-align:center">
        <img src="<?php echo e(public_path($signer->signer_url1)); ?>" style="width: 70px" alt="">
        <div style="margin-top: -5px;font-size:16px"><?php echo e(HP::formatDateThaiFullNumThai($signer->signer_2->updated_at)); ?></div>
    </div>
    
</div>

<div style="position: relative;margin-top:20px;line-height:1.15">
    <div Style="margin-bottom:5px;">เรียน &nbsp;&nbsp;&nbsp; ผอ.สก. ผ่าน ผก.รป.<?php echo e($boardAuditorMsRecordInfo->body_text1); ?></div>
    ...
    <div>
        ...
        <div style="text-indent: 100px;display:block;font-size:22px;word-spacing: -0.2em"><?php echo $textResult; ?></div>
    </div>
...
<div style="text-align: center;">
    <div style="text-align: center; margin-top: 20px;">
        <span>-<?php echo e(HP::toThaiNumber(2)); ?>-</span>
    </div>
</div>
    ...
    <div style="position: relative;padding-top:10px; line-height:1.15">
            ...
            <table style="border-collapse: collapse;margin-left:90px;">
                ...
                <?php $__currentLoopData = $data->statusAuditorMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusId => $auditorIds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $auditorIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auditorId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr>
                            <td style="width: 180px"><?php echo e(HP::toThaiNumber($index)); ?>. <?php echo e($info->auditorInformation->title_th); ?><?php echo e($info->auditorInformation->fname_th); ?> <?php echo e($info->auditorInformation->lname_th); ?></td>
                            <td style="width: 100px"><?php echo e($info->auditorInformation->number_auditor); ?></td>
                            <td style="padding-left:10px;word-spacing: -0.2em"><?php echo $textResult; ?></td>
                        </tr>
        ...
        <p style="margin: top 0;letter-spacing: 0.1px;"> <span style="letter-spacing: 0.1px;">เพื่ออนุมัติการแต่งตั้งคณะผู้ตรวจประเมินเพื่อดําเนินการตรวจประเมินให้การรับรองห้องปฏิบัติการ<?php echo e($data->lab_type); ?> ห้องปฏิบัติการ<?php echo e($data->lab_name); ?></span>รายละเอียดดังข้างต้น</p>
    ...
    <div style="text-align: center;">
        <div style="text-align: center; margin-top: 20px;">
            <span>-<?php echo e(HP::toThaiNumber(3)); ?>-</span>
        </div>
    </div>
...
<div style="padding-top:30px">
    <table style="width: 100%;text-align:center;">
        <tr>
            ...
            <td>  <img src="<?php echo e(public_path($signer->signer_url2)); ?>" style="width: 70px" alt=""></td>
        </tr>
        <tr>
            <td style="width:40%"></td>
            <td><?php echo e($signer->signer_1->signer_name); ?></td>
        </tr>
        <tr>
            <td></td>
            <td><?php echo e($signer->signer_1->signer_position); ?></td>
        </tr>
        <tr>
            <td style="width:40%"></td>
            <td><?php echo e(HP::formatDateThaiFullNumThai($signer->signer_1->updated_at)); ?></td>
        </tr>
    </table>
</div>
        ...
        <div style="position: relative;padding-top:10px ;line-height:1.18">
            ...
            <div style="letter-spacing: 0.1px;">รับรองห้องปฏิบัติการ<?php echo e($data->lab_type); ?> <?php echo e($data->lab_name); ?> ตามวันและเวลา ดังกล่าว</div>

            <table style="width: 100%;text-align:center;margin-top:20px">
                <tr>
                    <td style="width:40%"></td>
                    <td>  <img src="<?php echo e(public_path($signer->signer_url3)); ?>" style="width: 70px" alt=""></td>
                </tr>
                <tr>
                    <td style="width:40%"></td>
                    <td><?php echo e($signer->signer_3->signer_name); ?></td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td style="width:40%"></td>
                    <td><?php echo e(HP::formatDateThaiFullNumThai($signer->signer_3->updated_at)); ?></td>
                </tr>
            </table>
...
<div style="text-align: center;">
    <div style="text-align: center; margin-top: 20px;">
        <span>-<?php echo e(HP::toThaiNumber(4)); ?>-</span>
    </div>
</div>
<div style="padding-top:70px">
    <table style="width: 100%;text-align:center">
        <tr>
            <td>
                <img src="<?php echo e(public_path($signer->signer_url4)); ?>" style="width: 70px" alt=""></td>
            <td style="width:45%"></td>
        </tr>
        <tr>
            <td><?php echo e($signer->signer_4->signer_name); ?></td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            <td ><?php echo e(HP::formatDateThaiFullNumThai($signer->signer_4->updated_at)); ?></td>
            <td></td>
        </tr>
    </table>
</div>
