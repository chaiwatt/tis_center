                ...
                <div class="row">
                     ...
                     <div class="col-md-10 text-left">
                         ...
                         <div class="checkbox checkbox-danger">
                            <input  type="checkbox"  disabled <?php echo e(($certi_lab_place->permanent_operating_site === 0) ? 'checked' : ''); ?>>
                            <label for="#">     &nbsp; สถานปฏิบัติการถาวร &nbsp; </label>
                        </div>
                        <div class="checkbox checkbox-danger">
                            <input  type="checkbox"  disabled <?php echo e(($certi_lab_place->off_site_operations === 0) ? 'checked' : ''); ?>>
                            <label for="#">     &nbsp; สถานปฏิบัติการนอกสถานที่   &nbsp; </label>
                        </div>
                        <div class="checkbox checkbox-danger">
                            <input  type="checkbox"  disabled <?php echo e(($certi_lab_place->temporary_operating_site === 0) ? 'checked' : ''); ?>>
                            <label for="#">     &nbsp; สถานปฏิบัติการชั่วคราว   &nbsp; </label>
                        </div>
                        <div class="checkbox checkbox-danger">
                            <input  type="checkbox"  disabled <?php echo e(($certi_lab_place->mobile_operating_facility === 0) ? 'checked' : ''); ?>>
                            <label for="#">     &nbsp; สถานปฏิบัติการเคลื่อนที่   &nbsp; </label>
                        </div>
                        <?php if($labTestRequest->count() == 0 && $labCalRequest->count() == 0): ?>
                            <div class="checkbox checkbox-danger">
                                <input  type="checkbox"  disabled <?php echo e(($certi_lab_place->multi_site_facility === 0) ? 'checked' : ''); ?>>
        ...
        <div class="col-md-11 col-md-offset-1">
              ...
              <div class="col-md-12">
                <div class="row">
                     <div class="col-md-2 text-right"> </div>
                     <div class="col-md-10 text-left">
                        <?php if($certi_lab->management_lab == 1): ?>
