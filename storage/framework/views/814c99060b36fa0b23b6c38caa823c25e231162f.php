...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-10">
            ...
            <div hidden class="form-group <?php echo e($errors->has('app_certi_lab_id') ? 'has-error' : ''); ?>">
                <?php echo HTML::decode(Form::label('app_certi_lab_id', '<span class="text-danger">*</span>  เลขคำขอ', ['class' => 'col-md-5 control-label'])); ?>

                <div class="col-md-7">
                    <?php echo Form::select('app_certi_lab_id', 
                        $app_certi_lab,
            ...
            <input type="hidden" name="view_url" value="<?php echo e($view_url); ?>">
            <div class="form-group <?php echo e($errors->has('no') ? 'has-error' : ''); ?>">
                ...
                <div class="col-md-7">
                    <input type="text" name="no" id="no" value="<?php echo e(old('no', $selectedCertiLab->user_created->contact_name)); ?>" class="form-control" maxlength="255" required>
                </div>
            </div>
            ...
            <div class="form-group <?php echo e($errors->has('auditor') ? 'has-error' : ''); ?>">
                ...
                <div class="col-md-7">
                    <?php echo Form::text('auditor', null, ['class' => 'form-control',  'maxlength' => '255', 'required' => true]);; ?>
            ...
            <div class="form-group">
                <?php echo HTML::decode(Form::label('select_user_id', '<span class="text-danger">*</span> ผู้ลงนามท้ายขอบข่าย', ['class' => 'col-md-5 control-label'])); ?>

                <div class="col-md-7">
                    <select name="select_user_id" id="select_user_id" class="form-control" required>
                        <option value="" selected>- ผู้ลงนามท้ายขอบข่าย -</option>
                        <?php $__currentLoopData = $signers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $signer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($signer->id); ?>" data-position="<?php echo e($signer->position); ?>"><?php echo e($signer->name); ?></option>
            ...
            <div class="form-group">
                <?php echo HTML::decode(Form::label('signer_1', '<span class="text-danger">*</span> เจ้าหน้าที่ผู้รับผิดชอบ', ['class' => 'col-md-5 control-label'])); ?>
            ...
            <div class="form-group">
                <?php echo HTML::decode(Form::label('signer_2', '<span class="text-danger">*</span> ผู้ลงนาม (ผก.)', ['class' => 'col-md-5 control-label'])); ?>
            ...
            <div class="form-group">
                <?php echo HTML::decode(Form::label('signer_3', '<span class="text-danger">*</span> ผู้ลงนาม (ผอ. สก.)', ['class' => 'col-md-5 control-label'])); ?>
            ...
            <div class="form-group">
                <?php echo HTML::decode(Form::label('signer_4', '<span class="text-danger">*</span> ผู้ลงนาม (ลมอ. / ผอ. สก.)', ['class' => 'col-md-5 control-label'])); ?>
            ...
            <div class="form-group <?php echo e($errors->has('attach') ? 'has-error' : ''); ?>">
                ...
                <div class="col-md-7">
                    <?php echo $errors->first('attach', '<p class="help-block">:message</p>'); ?>
    ...
    // console.log(data); // ดูค่าที่ดึงได้
        ...
        $(document).ready(function () {
           ...
           $('.date-range').datepicker({
                           ...
                           if(object.cost_item  != '-'){
                              $.each(object.cost_item, function( index, item ) {
                                ...
                                html += '<td>';
                                    ...
                                    html +=  '</select>' ; 
                                    // html +=  '<?php echo Form::select('detail[desc][]', App\Models\Bcertify\StatusAuditor::orderbyRaw('CONVERT(title USING tis620)')->pluck('title', 'id'), '+ item.desc +',   ['class' => 'form-control select2 desc', 'required'=>true,'placeholder'=>'- เลือกรายละเอียดประมาณค่าใช้จ่าย -']);; ?>'; 
                                html += '</td>';
                                html += '<td>';
            ...
            var lab_id    = '<?php echo e(!empty($request->app_certi_lab_id) ?  $request->app_certi_lab_id : null); ?>'  ;
            if(lab_id != null){
        ...
        function statusChange(that) {
            ...
            if(app_lab_id == ''){
                ...
                let url = '<?php echo e(url('/certify/auditor/status')); ?>'+'/'+id +'/'+ app_lab_id;
                $.ajax({
                    type: 'get',
                    url: url,
