        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <?php echo Form::model($assessment, [
                        'method' => 'POST',
 ...
 <div id="box-readonly">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                            <input type="text" class="form-control"
                                             value="<?php echo e($assessment->AuditorsTitle ?? null); ?>"   disabled >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="col-md-4 text-right">ชื่อผู้ยื่นคำขอ : </label>
                                    <div class="col-md-8">
                                        <?php echo Form::text('name', null,  ['class' => 'form-control', 'id'=>'applicant_name','disabled'=>true]); ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo Form::text('laboratory_name', null,  ['class' => 'form-control', 'id'=>'laboratory_name','disabled'=>true]); ?>
                                    ...
                                    <div class="col-md-8">
                                        <?php if(isset($assessment)  && !is_null($assessment->FileAttachAssessment1To)): ?> 
                                              <p id="RemoveFlie">
                                                   ...
                                                   <a href="<?php echo e(url('certify/check/file_cb_client/'.$assessment->FileAttachAssessment1To->file.'/'.( !empty($assessment->FileAttachAssessment1To->file_client_name) ? $assessment->FileAttachAssessment1To->file_client_name : 'null' ))); ?>" 
                                                        title="<?php echo e(!empty($assessment->FileAttachAssessment1To->file_client_name) ? $assessment->FileAttachAssessment1To->file_client_name :  basename($assessment->FileAttachAssessment1To->file)); ?>" target="_blank">
                                                        <?php echo HP::FileExtension($assessment->FileAttachAssessment1To->file)  ?? ''; ?>

                                                    </a>
                                                
 
                                                <button class="btn btn-danger btn-xs div_hide" type="button"
                                                 onclick="RemoveFlie(<?php echo e($assessment->FileAttachAssessment1To->id); ?>)">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="col-md-6">
                            <?php if(!is_null($assessment) && (count($assessment->FileAttachAssessment4Many) > 0 ) ): ?>
                                <?php $__currentLoopData = $assessment->FileAttachAssessment4Many; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <p id="remove_attach_all<?php echo e($item->id); ?>">
                                    
                                         <a href="<?php echo e(url('certify/check/file_cb_client/'.$item->file.'/'.( !empty($item->file_client_name) ? $item->file_client_name : 'null' ))); ?>" 
                                    ...
                                    <button class="btn btn-danger btn-xs deleteFlie div_hide"
                                         type="button" onclick="deleteFlieAttachAll(<?php echo e($item->id); ?>)">
                                         <i class="icon-close"></i>
                                    </button>   
                                </p>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <hr>
                        ...
                        <div class="clearfix"></div>
                         <?php echo $__env->make('certify/cb.save_assessment_cb/form.log_bug', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

     
                         <div class="clearfix"></div>
                          <?php if($assessment->degree == 2 || $assessment->degree == 8): ?>
                          <?php echo $__env->make('certify/cb.save_assessment_cb/form.bug', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                          <?php endif; ?>
                          <?php if($assessment->degree >= 5 || $assessment->degree == 8): ?>
                          <?php echo $__env->make('certify/cb.save_assessment_cb/form.log_inspection', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                          <?php endif; ?>
</div>

<?php if($assessment->degree == 5): ?>
...
<?php endif; ?>
         ...
         <?php if(in_array($assessment->degree,[2,5,8])): ?>
                       <input type="hidden" name="previousUrl" id="previousUrl" value="<?php echo e($previousUrl ?? null); ?>">
                         <div id="degree_btn"></div>
                       <div class="form-group">
                        <div class="col-md-offset-5 col-md-6">
                            
                            <div  class="status_bug_report <?php echo e(($assessment->bug_report == 2)?'hide':''); ?>"> 
                                <label><?php echo Form::checkbox('main_state', '2',($assessment->main_state == 2)?true:false, ['class'=>'check','data-checkbox'=>"icheckbox_flat-red"]); ?> 
                                    &nbsp;ปิดผลการตรวจประเมิน&nbsp;
                                 </label>
                             </div> 
                            ...
                            <a class="btn btn-default" href="<?php echo e(url("$previousUrl")); ?>"><i class="fa fa-rotate-left"></i> ยกเลิก </a>
                        </div>
                      </div>
         <?php else: ?> 
                      <div class="clearfix"></div>
...
<?php $__env->startPush('js'); ?>
  ...
  <script>
    jQuery(document).ready(function() {
        let degree = '<?php echo e(!empty($assessment->degree)  ? $assessment->degree : null); ?>';
  ...
  <script>
         ...
         function  submit_form(){
            ...
            let bug_report = '<?php echo e(!empty($assessment->bug_report)  ?  $assessment->bug_report : 1); ?>';
            let title = '';
            let l = '';
            if(bug_report == 2){
    ...
    $(document).ready(function(){
        ...
        let check_readonly = '<?php echo e(($assessment->bug_report == 1)  ? 1 : 2); ?>';
        if(check_readonly == 1){
            $('.check-readonly').prop('disabled', true);
            $('.check-readonly').parent().removeClass('disabled');
            $('.check-readonly').parent().css({"background-color": "rgb(238, 238, 238);","border-radius":"50%"});
   ...
   function  deleteFlieAttachAll(id){
          Swal.fire({
                ...
                cancelButtonText: 'ยกเลิก'
                    ...
                    if (result.value) {
                       $.ajax({
                            url: "<?php echo url('/certify/check_certificate-cb/delete_file'); ?>"  + "/" + id
