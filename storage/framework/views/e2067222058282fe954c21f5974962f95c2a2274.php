...
<link rel="stylesheet" href="<?php echo e(asset('plugins/components/jquery-datatables-editable/datatables.css')); ?>" />
                ...
                <div class="white-box">
                    ...
                    <div class="row ">
                      <div class="col-md-6 form-group">
                            ...
                            <?php echo Form::select('filter_certificate_type',
                                 ['0'=>'CB','1'=>'IB','2'=>'LAB'], 
                                null, 
                                ['class' => 'form-control', 
                      ...
                      <div class="col-md-4">
                               <?php echo Form::select('filter_state',
...
<script src="<?php echo e(asset('plugins/components/jquery-datatables-editable/jquery.dataTables.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/components/datatables/dataTables.bootstrap.js')); ?>"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '<?php echo url('/certify/auditor-assignment/data-list'); ?>',
                    data: function (d) {
            ...
            //     searching: false,
            //     ajax: {
            //         url: '<?php echo url('/certify/send-certificates/data_list'); ?>',
            //         data: function (d) {
            ...
            $(document).on('click', '#bulk_delete', function(){
                ...
                if(id.length > 0){
                    ...
                    if (confirm("ยืนยันการลบข้อมูล " + id.length + " แถว นี้ ?")) {
                        $.ajax({
                                type:"POST",
                                url:  "<?php echo e(url('/certify/send-certificates/delete')); ?>",
                                data:{
        ...
        $(document).on('click', '.btn-warning', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('auditor_assignment.get_signer')); ?>", // URL ของ route
                type: 'GET',
        ...
        $(document).on('click', '#signDocument', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('auditor_assignment.signDocument')); ?>",
                type: 'POST',
                data: { 
...
$(document).on('click', '.sign-document', function() {
    ...
    $.ajax({
        url: "<?php echo e(route('auditor_assignment.get_signer')); ?>",
        type: 'GET',
        data: { 
            signer_id: signer_id
        },
