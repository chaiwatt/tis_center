        ...
        <div class="col-md-11 col-md-offset-1">
                <div class="row">
                     <div class="col-md-12 text-left">
                        <?php if(!is_null($certi_lab_attach_all5) && $certi_lab_attach_all5->count() > 0): ?>
                            <div class="row">
                                <?php $__currentLoopData = $certi_lab_attach_all5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($data->file): ?>
