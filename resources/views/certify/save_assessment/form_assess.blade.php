                    ...
                    <div class="row">
                        <div class="col-md-12">
                          ...
                          <legend><h4>บันทึกการแก้ไขข้อบกพร่อง / ข้อสังเกต</h4></legend>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span class="text-warning">(ยังไม่ได้สร้าง)</span>
                                            ...
                                            <span class="fileinput-exists">เปลี่ยน</span>
                                                <input type="file" name="file" required class="input_required check_max_size_file">
                                                </span>
                            ...
                            {{-- {{$find_notice->report_status}} --}}
                            @if(!is_null($find_notice) && !is_null($find_notice->file) )
                                @if ($find_notice->report_status  == 1)
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="col-md-3 text-right"><span class="text-danger">*</span> รายงานการตรวจประเมินและไฟล์ข้อบกพร่อง: </label>
                                            <div class="col-md-6">
                                                
                                                <a class="btn btn-primary btn-sm" id="mergeBtn" style="pointer-events: auto;">ดาวน์โหลด</a>
